...
// const adaptMongooseSchema = require('./adaptMongooseSchema')
  ...
  class CosmosClientWrapper {
    ...
    createMongooseModel(modelName, mongooseSchema, mongooseInstance) {
      ...
      try {
        ...
        // mongooseSchema.set('bufferCommands', false)

        // adaptMongooseSchema({ cosmosClientWrapper: this, mongooseSchema })
