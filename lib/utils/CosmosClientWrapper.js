...
const { ensureObjectFollowsSchema } = require('./validity')
  ...
  class CosmosClientWrapper {
    ...
    constructor(options) {
      ...
      if (this.retryStrategy) {
        const ensureValidRetryStrategy = StrategyUtils.getRetryStrategy
        ensureValidRetryStrategy(this.retryStrategy)
      }
