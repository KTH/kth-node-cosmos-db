...
async function getContainerByDatabase(containerName, database) {
  ...
  // try {
  //   const container = database.container('huhu')
  ...
  //     name: 'lexa1',
  //     error: error.message,
  //     test: /resource not found/i.test(error.message),
  //   })
  ...
  if (knownContainerNames.includes(containerName)) {
    // _once(() =>
    //   console.log(`getContainerByDatabase() - successful`, {
    //     containerName,
    //     allContainerDefinitions,
    //   })
    // )
  ...
  // console.log(`getContainerByDatabase() - not found`, { containerName, allContainerDefinitions })
  // done = false
