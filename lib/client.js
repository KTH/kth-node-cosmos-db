...
const devDefaults = {
  increaseCollectionThroughput: () =>
    log.debug(`kth-node-cosmos-db: increaseCollectionThroughput is not implemented in development`),
  updateCollectionThroughput: () =>
    log.debug(`kth-node-cosmos-db: updateCollectionThroughput is not implemented in development`),
  ...
  init: () => {
    log.debug(`kth-node-cosmos-db: init is not implemented in development`)
  }
}
