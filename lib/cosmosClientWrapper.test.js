...
describe('Functions', () => {
  ...
  test('After a client is created. You should be able to create databases and collectoins.', () => {
    getClient()
      .init()
      .then(() => {})
  })
  ...
  test('You can increase a named collections throughput, by a default increase.', async () => {
    const client = getClient()
  ...
  test.todo('You can increase all collections throughput, by a default increase.', async () => {
    const client = getClient()
