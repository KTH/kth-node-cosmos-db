...
function getClientWithInactiveMethods() {
  return {
    increaseCollectionThroughput: () => log.info(`Not available in native MongoDB.`),
    updateCollectionThroughput: () => log.info(`Not available in native MongoDB.`),
    updateAllCollectionsThroughput: () => log.info(`Not available in native MongoDB.`),
    listCollectionsWithThroughput: () => log.info(`Not available in native MongoDB.`),
    getCollectionThroughput: () => log.info(`Not available in native MongoDB.`),
    resetThroughput: () => log.info(`Not available in native MongoDB.`),
    init: () => log.info(`Not available in native MongoDB.`)
  }
}
